...
namespace MyDubai.Web.API
{
    ...
    */
    public class UsersController : ODataController
    {
        ...
        //sample url for get single http://localhost:31697/odata/Users('admin') this will get the user whose username is admin
        // GET: odata/Users(5)
        [EnableQuery]
        public SingleResult<User> GetUser([FromODataUri] string key)
        {
            return SingleResult.Create(db.Users.Where(user => user.Username == key));
        }
        ...
        {
            return db.Users.Count(e => e.Username == key) > 0;
        }
    }
}
